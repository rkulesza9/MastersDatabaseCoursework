<?php
  ...
  function manager_logged_in(){
    return isset($_COOKIE['user_role']) & $_COOKIE['user_role'] == 'M';
  }
...
<?php //function to create google charts table of products given a search phrase and customer/emp (customer->no cost) ?>



<?php //function to create dropdown of vendors ?>
<?php function dropdown_vendors(){
        ...
        while($stmt->fetch()){ ?>
            <option value='<?php echo $vendor_id; ?>'><?php echo $name; ?></option>
<?php   }
        echo "</select>";
      }
?>
