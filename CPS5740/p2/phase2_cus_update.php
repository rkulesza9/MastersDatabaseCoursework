...
<html>
  ...
  <body>
    <?php if(customer_logged_in()){ ?>
      ...
      <a href='phase2_cus_login.php?logout=true'>Customer logout</a>
      <form action='phase2_cus_update.php' method='post'>
        <table>
        ...
        <a href='phase2_cus_login.php'>Customer's home page</a><br>
